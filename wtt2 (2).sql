...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2024 a las 08:34:55
...
(1, 'Sigueqq', 'EDITADO', 'cioqq', 'nandoqq', 'tienda'),
...
(19, 'Pantalla Servidor', 'Pantalla', 'SMI123346', 'Activo', 'tienda');
...
(20, 'App\\Models\\User', 32, 'main', '4cfddc13a67537f6f56c5c7b3159a4e2015a05122ec9170f92cd664a116346a0', '[\"*\"]', NULL, NULL, '2024-04-09 10:48:35', '2024-04-09 10:48:35'),
(21, 'App\\Models\\User', 32, 'main', '30e645fd18181efb0cf22cad68be4f7384c4a334f9d1471f967817eae0249e07', '[\"*\"]', '2024-04-09 11:31:31', NULL, '2024-04-09 11:02:36', '2024-04-09 11:31:31');
...
--
-- Volcado de datos para la tabla `ticket_mantenimiento`
--

INSERT INTO `ticket_mantenimiento` (`id_ticket`, `descripcion`, `fecha_creacion`, `estado`) VALUES
(1, 'Reemplazo de piezas en la máquina de impresión', '2024-04-05 09:30:00', 'En progreso'),
(2, 'Limpieza y mantenimiento preventivo del equipo de computación', '2024-04-04 15:45:00', 'Pendiente'),
(3, 'Reparación de la red de cableado', '2024-04-03 11:20:00', 'Completado'),
(4, 'Actualización del software de gestión de inventario', '2024-04-02 14:10:00', 'Pendiente'),
(5, 'Inspección y mantenimiento del sistema de refrigeración', '2024-04-01 10:00:00', 'En progreso');
...
(35, 'Santi', 'santi@gmail.com', NULL, '$2y$10$QnxujWYdtsI/KIrNj6BZqeX8nq1UA3iagwKTlNPvM6LbaSieyfJpi', NULL, '2024-04-09 09:23:53', '2024-04-09 09:23:53'),
(36, 'Pepesito', 'pepe@gmail.com', NULL, '$2y$10$suF6SafeuKoJ9U7SUGTzluLjl9ZLhVVMQ2/dsmltXPU8atepIbQxa', NULL, '2024-04-09 10:02:02', '2024-04-09 10:02:16');
...
--
-- Indices de la tabla `ticket_mantenimiento`
--
ALTER TABLE `ticket_mantenimiento`
...
--
-- AUTO_INCREMENT de la tabla `ticket_mantenimiento`
--
ALTER TABLE `ticket_mantenimiento`
